...
# two student's grades. After this, calculate the student's average, considering that 
# grade A has weight 3.5 and B has weight 7.5. Each grade can be from zero to ten, 
...
average = ((valueOne*3.5 + valueTwo*7.5)/11)
